...
#### Deploy in your VPS
````bash
git clone https://github.com/Flayo112/File-Sharing-Bot
cd File-Sharing-Bot
...
[FILE-SHARING-BOT](https://github.com/Flayo112/File-Sharing-Bot/) is Free Software: You can use, study share and improve it at your
